package com.example.feedbackapp.ThirdParty.CircularProgress;
...
//        theta += Math.PI/2.0;
    ...
    public void setClippingBitmap(Bitmap _clippingBitmap)
    {
        ...
        {
            mClippingBitmap = Bitmap
                    .createScaledBitmap(_clippingBitmap, getWidth(), getHeight(), false);
        }
        else
        {
    ...
    private void parseAttributes(TypedArray a)
    {
        ...
        if (a.hasValue(R.styleable.CircleProgressView_cpv_barColor) && a
                .hasValue(R.styleable.CircleProgressView_cpv_barColor1) && a
                .hasValue(R.styleable.CircleProgressView_cpv_barColor2) && a
                .hasValue(R.styleable.CircleProgressView_cpv_barColor3))
        {
        ...
        else if (a.hasValue(R.styleable.CircleProgressView_cpv_barColor) && a
                .hasValue(R.styleable.CircleProgressView_cpv_barColor1) && a
                .hasValue(R.styleable.CircleProgressView_cpv_barColor2))
        {
            ...
            mBarColors = new int[]{a.getColor(R.styleable.CircleProgressView_cpv_barColor, mBarColorStandard), a.getColor(R.styleable.CircleProgressView_cpv_barColor1, mBarColorStandard), a.getColor(R.styleable.CircleProgressView_cpv_barColor2, mBarColorStandard)};
                ...
                .hasValue(R.styleable.CircleProgressView_cpv_barColor1))
        {
        ...
        {
            setBarStrokeCap(StrokeCap.values()[a
                    .getInt(R.styleable.CircleProgressView_cpv_barStrokeCap, 0)].paintCap);
        }

        if (a.hasValue(R.styleable.CircleProgressView_cpv_barStartEndLineWidth) && a
                .hasValue(R.styleable.CircleProgressView_cpv_barStartEndLine))
        {
            setBarStartEndLine((int) a
                            .getDimension(R.styleable.CircleProgressView_cpv_barStartEndLineWidth, 0),
                    BarStartEndLine.values()[a
                            .getInt(R.styleable.CircleProgressView_cpv_barStartEndLine, 3)],
        ...
        {
            setTextSize((int) a
                    .getDimension(R.styleable.CircleProgressView_cpv_textSize, mTextSize));
        }
        if (a.hasValue(R.styleable.CircleProgressView_cpv_unitSize))
        {
            setUnitSize((int) a
                    .getDimension(R.styleable.CircleProgressView_cpv_unitSize, mUnitTextSize));
        }
        ...
        {
            setTextColorAuto(a
                    .getBoolean(R.styleable.CircleProgressView_cpv_autoTextColor, mIsAutoColorEnabled));
        }
        if (a.hasValue(R.styleable.CircleProgressView_cpv_autoTextSize))
        {
            setAutoTextSize(a
                    .getBoolean(R.styleable.CircleProgressView_cpv_autoTextSize, mIsAutoTextSize));
        }
        if (a.hasValue(R.styleable.CircleProgressView_cpv_textMode))
        {
            setTextMode(TextMode.values()[a
                    .getInt(R.styleable.CircleProgressView_cpv_textMode, 0)]);
        }
        if (a.hasValue(R.styleable.CircleProgressView_cpv_unitPosition))
        {
            setUnitPosition(UnitPosition.values()[a
                    .getInt(R.styleable.CircleProgressView_cpv_unitPosition, 3)]);
        }
        ...
        setOuterContourColor(a
                .getColor(R.styleable.CircleProgressView_cpv_outerContourColor, mOuterContourColor));
        setOuterContourSize(a
                .getDimension(R.styleable.CircleProgressView_cpv_outerContourSize, mOuterContourSize));

        setInnerContourColor(a
                .getColor(R.styleable.CircleProgressView_cpv_innerContourColor, mInnerContourColor));
        setInnerContourSize(a
                .getDimension(R.styleable.CircleProgressView_cpv_innerContourSize, mInnerContourSize));

        setMaxValue(a.getFloat(R.styleable.CircleProgressView_cpv_maxValue, mMaxValue));

        setMinValueAllowed(a
                .getFloat(R.styleable.CircleProgressView_cpv_minValueAllowed, mMinValueAllowed));
        setMaxValueAllowed(a
                .getFloat(R.styleable.CircleProgressView_cpv_maxValueAllowed, mMaxValueAllowed));

        setRoundToBlock(a
                .getBoolean(R.styleable.CircleProgressView_cpv_roundToBlock, mRoundToBlock));
        setRoundToWholeNumber(a
                .getBoolean(R.styleable.CircleProgressView_cpv_roundToWholeNumber, mRoundToWholeNumber));
        ...
        setSeekModeEnabled(a
                .getBoolean(R.styleable.CircleProgressView_cpv_seekMode, mSeekModeEnabled));

        setStartAngle(a.getInt(R.styleable.CircleProgressView_cpv_startAngle, mStartAngle));

        setShowTextWhileSpinning(a
                .getBoolean(R.styleable.CircleProgressView_cpv_showTextInSpinningMode, mShowTextWhileSpinning));
        ...
        if (a.hasValue(R.styleable.CircleProgressView_cpv_textTypeface))
        {
            try
            {
                textTypeface = Typeface.createFromAsset(getContext().getAssets(), a
                        .getString(R.styleable.CircleProgressView_cpv_textTypeface));
            }
        ...
        if (a.hasValue(R.styleable.CircleProgressView_cpv_unitTypeface))
        {
            try
            {
                unitTextTypeface = Typeface.createFromAsset(getContext().getAssets(), a
                        .getString(R.styleable.CircleProgressView_cpv_unitTypeface));
            }
            catch (Exception exception)
            {
                // error while trying to inflate typeface (is the path set correctly?)
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh)
    {
        ...
        {
            mClippingBitmap = Bitmap
                    .createScaledBitmap(mClippingBitmap, getWidth(), getHeight(), false);
        }
    ...
    private RectF getInnerCircleRect(RectF _circleBounds)
    {
        ...
        double circleWidth = +_circleBounds.width() - (Math
                .max(mBarWidth, mRimWidth)) - mOuterContourSize - mInnerContourSize;
    ...
    private int calcTextColor(double value)
    {
        if (mBarColors.length > 1)
        {
            ...
            return ColorUtils
                    .getRGBGradient(mBarColors[low], mBarColors[high], (float) (1 - (((mBarColors.length - 1) * percent) % 1d)));
        }
                                                          ...
                                                          float unitGapHeightHalf, float unitHeight)
    {
        ...
        mUnitTextPaint
                .setTextSize(calcTextSizeForRect(mUnit, mUnitTextPaint, mUnitBounds) * mUnitScale);
    ...
    private void setUnitTextBoundsAndSizeWithFixedTextSize(float unitGapWidth, float unitGapHeight)
    {
        ...
        switch (mUnitPosition)
        {
            ...
            case TOP:
                mUnitBounds
                        .offsetTo(mUnitBounds.left, mActualTextBounds.top - unitGapHeight - mUnitBounds
                                .height());
                break;
            case BOTTOM:
            ...
            case LEFT_TOP:
            case LEFT_BOTTOM:
                mUnitBounds.offsetTo(mActualTextBounds.left - unitGapWidth - mUnitBounds
                        .width(), mUnitBounds.top);
                break;
            case RIGHT_TOP:
            case RIGHT_BOTTOM:
            default:
    ...
    private RectF calcTextBounds(String _text, Paint _textPaint, RectF _textBounds)
    {
        ...
        float height = textBoundsTmp.bottom + textBoundsTmp
                .height() * 0.93f; // the height of calcTextBounds is a bit to high, therefore  * 0.93
        //center in circle
    ...
    private void setupBarPaint()
    {
        if (mBarColors.length > 1)
        {
            mBarPaint.setShader(new SweepGradient(mCircleBounds.centerX(), mCircleBounds
                    .centerY(), mBarColors, null));
            Matrix matrix = new Matrix();
    ...
    private void drawBlocks(Canvas _canvas, RectF circleBounds, float startAngle, float _degrees,
                            boolean userCenter, Paint paint)
    {
        float tmpDegree = 0.0f;
        while (tmpDegree < _degrees)
        {
            _canvas.drawArc(circleBounds, startAngle + tmpDegree, Math
                    .min(mBlockScaleDegree, _degrees - tmpDegree), userCenter, paint);
    ...
    private void drawTextWithUnit(Canvas canvas)
    {
        ...
        if (mTextLength != text.length())
        {
            ...
            {
                mOuterTextBounds = getInnerCircleRect(mCircleBounds);
                mOuterTextBounds = new RectF(mOuterTextBounds.left + (mOuterTextBounds
                        .width() * 0.1f), mOuterTextBounds.top, mOuterTextBounds.right - (mOuterTextBounds
                        .width() * 0.1f), mOuterTextBounds.bottom);
            }
            else
            {
                mOuterTextBounds = getInnerCircleRect(mCircleBounds);
        ...
        canvas.drawText(text, mActualTextBounds.left - (mTextPaint
                .getTextSize() * 0.02f), mActualTextBounds.bottom, mTextPaint);
        ...
        if (mShowUnit)
        {
            ...
            canvas.drawText(mUnit, mUnitBounds.left - (mUnitTextPaint
                    .getTextSize() * 0.02f), mUnitBounds.bottom, mUnitTextPaint);
        }
    }
