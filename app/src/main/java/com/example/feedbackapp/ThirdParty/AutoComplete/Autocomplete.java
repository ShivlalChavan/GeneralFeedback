...
public final class Autocomplete<T> implements TextWatcher, SpanWatcher
{
    ...
    private Autocomplete(Builder<T> builder)
    {
        ...
        popup.setElevation(TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, builder.elevationDp,
    ...
    public void showPopup(@NonNull CharSequence query)
    {
        ...
        if (!isPopupShowing())
        {
            ...
            presenter
                    .registerDataSetObserver(new Observer()); // Calling new to avoid leaking... maybe...
