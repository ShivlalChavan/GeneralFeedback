package com.example.feedbackapp.ThirdParty.AutoComplete;
...
class AutocompletePopup
{
    ...
    public void setmPopup(PopupWindow mPopup)
    {
        this.mPopup = mPopup;
    }
    ...
    void show()
    {
        ...
        else
        {
            ...
            mPopup.setOutsideTouchable(isOutsideTouchable());
            PopupWindowCompat
                    .showAsDropDown(mPopup, getAnchorView(), mHorizontalOffset, mVerticalOffset, mGravity);
        }
    }
    ...
    private int buildDropDown()
    {
        ...
        final boolean ignoreBottomDecorations = mPopup
                .getInputMethodMode() == PopupWindow.INPUT_METHOD_NOT_NEEDED;
        ...
        final int maxContentWidth = mContext.getResources()
        ...
        switch (mWidth)
        {
            case ViewGroup.LayoutParams.WRAP_CONTENT:
                childWidthSpec = View.MeasureSpec
                        .makeMeasureSpec(maxContentWidth, View.MeasureSpec.AT_MOST);
                break;
            case ViewGroup.LayoutParams.MATCH_PARENT:
                childWidthSpec = View.MeasureSpec
                        .makeMeasureSpec(maxContentWidth, View.MeasureSpec.EXACTLY);
                break;
            default:
                //noinspection Range
        ...
        mView.measure(childWidthSpec, View.MeasureSpec
                .makeMeasureSpec(maxContentHeight, View.MeasureSpec.AT_MOST));
