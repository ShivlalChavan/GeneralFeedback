...
public class ApplicationLifeCycle implements Application.ActivityLifecycleCallbacks {
    ...
    private boolean ApplicationLifeCycle = false, paused = true;
     ...
     *
     * @param application
     * @return an initialised ApplicationLifeCycle instance
     */
    ...
    public static ApplicationLifeCycle get(Context ctx){
        if (instance == null) {
            ...
            throw new IllegalStateException(
                    "ApplicationLifeCycle is not initialised and " +
    ...
    public static ApplicationLifeCycle get(){
        if (instance == null) {
            throw new IllegalStateException(
                    "ApplicationLifeCycle is not initialised - invoke " +
    ...
    public void onActivityResumed(Activity activity) {
        paused = false;
        boolean wasBackground = !ApplicationLifeCycle;
        ...
        if (wasBackground){
            Log.i(TAG, "went ApplicationLifeCycle");
            ...
            Log.i(TAG, "still ApplicationLifeCycle");
        }
    }
    ...
    public void onActivityPaused(Activity activity) {
        ...
        handler.postDelayed(check = new Runnable(){
            @Override
            public void run() {
                if (ApplicationLifeCycle && paused) {
                    ApplicationLifeCycle = false;
