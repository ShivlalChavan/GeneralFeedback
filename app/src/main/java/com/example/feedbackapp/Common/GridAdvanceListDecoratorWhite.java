...
public class GridAdvanceListDecoratorWhite extends RecyclerView.ItemDecoration {
    ...
    public GridAdvanceListDecoratorWhite(Context context) {
        TypedArray a = context.obtainStyledAttributes(ATTRS);
        mDivider = context.getResources().getDrawable(R.drawable.white_line_divider);
        a.recycle();

        mInsets = context.getResources().getDimensionPixelSize(R.dimen.spacing);
    }
